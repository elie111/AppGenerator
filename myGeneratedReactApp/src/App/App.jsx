...
"home":  <>
    ...
    <Section key="section1" className="section1" params={{}}  stateManagers={stateManagers} nested={[<>
...
"profile":  <>
    ...
    <Section key="section2" className="section2" params={{}}  stateManagers={stateManagers} nested={[<>
...
"login":  <>
    ...
    <Section key="sectionLogin" className="sectionLogin" params={{}}  stateManagers={stateManagers} nested={[<>
...
"signup":  <>
    ...
    <Section key="sectionSignup" className="sectionSignup" params={{}}  stateManagers={stateManagers} nested={[<>
